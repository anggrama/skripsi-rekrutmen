        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    if (pangkat.ToLower() != "taruna/taruni tni" && pangkat.ToLower() != "pa pk tni umum" && pangkat.ToLower() != "pa pk tni susgakes" && pangkat.ToLower() != "pa psdp pnb" && pangkat.ToLower() != "pa psdp tani" && pangkat.ToLower() != "bintara tni ad" && pangkat.ToLower() != "bintara tni al" && pangkat.ToLower() != "bintara tni au" && pangkat.ToLower() != "tamtama tni ad" && pangkat.ToLower() != "tamtama tni al" && pangkat.ToLower() != "tamtama tni au")
                    {
